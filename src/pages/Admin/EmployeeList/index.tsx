...
export default function EmployeeList() {
  ...
  useEffect(() => {
    async function fetchEmployees() {
      try {
        // Ajuste o endpoint "/employees" conforme sua API real (ex: /company/employees ou /users)
        // Se a rota for /users ou algo diferente, mude aqui.
  ...
  // Lógica para preencher linhas vazias e manter o layout bonito
  const totalRows = 10;
          ...
          <div className="bg-white w-full max-w-5xl rounded-3xl shadow-xl overflow-hidden flex flex-col min-h-[600px]">
            <div className="p-8">
              ...
              <div className="border-t-2 border-black">
                ...
                {/* Preenche com linhas vazias se tiver poucos itens */}
                {!loading &&
