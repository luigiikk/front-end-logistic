      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-1/4 bg-[#bfdbf7] flex flex-col items-center py-10 gap-8 min-w-[250px]">
          ...
          <nav className="flex flex-col gap-6 w-full px-12">
            ...
            {/* Botão CADASTRO (Ativo - Sem Link ou Link para si mesmo) */}
            ...
            {/* Botão CONSULTA (Link para a tela de Consulta) */}
        ...
        <main className="flex-1 p-8 flex justify-center items-center overflow-y-auto">
          <div className="bg-white w-full max-w-4xl rounded-3xl shadow-xl p-10 flex flex-col justify-center min-h-[600px]">
            ...
            <form className="flex flex-col gap-4 w-full px-4 md:px-12">
              <input type="text" placeholder="Registro" className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black placeholder-black outline-none focus:ring-2 focus:ring-gray-400 shadow-inner" />
              <input type="text" placeholder="Nome Completo" className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black placeholder-black outline-none focus:ring-2 focus:ring-gray-400 shadow-inner" />
              <input type="text" placeholder="Telefone" className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black placeholder-black outline-none focus:ring-2 focus:ring-gray-400 shadow-inner" />
              <input type="email" placeholder="Email" className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black placeholder-black outline-none focus:ring-2 focus:ring-gray-400 shadow-inner" />
              
              <select className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black outline-none focus:ring-2 focus:ring-gray-400 appearance-none shadow-inner cursor-pointer" defaultValue="">
              ...
              <input type="password" placeholder="Senha" className="w-full bg-[#d9d9d9] border border-gray-500 rounded-xl py-3 px-4 text-lg text-black placeholder-black outline-none focus:ring-2 focus:ring-gray-400 shadow-inner" />

              <div className="flex justify-center mt-6">
                <button type="submit" className="bg-[#cfcfcf] border border-gray-600 text-black font-bold py-3 px-12 rounded-xl hover:bg-[#b0b0b0] transition-colors shadow-md cursor-pointer">
                  Cadastre
                </button>
              </div>
            </form>
